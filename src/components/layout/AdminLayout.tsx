...
export const AdminLayout: React.FC = () => (
  <div className="min-h-screen bg-canvas text-ink flex font-sans" dir="rtl">
    <Sidebar />
    <div className="flex-1 lg:mr-64 mr-0 flex flex-col min-w-0 min-h-screen">
      <main className="flex-1 p-4 sm:p-6 lg:p-8 max-w-7xl w-full mx-auto">
        <Outlet />
      </main>
      <footer className="px-4 sm:px-8 py-4 border-t border-line text-xs text-muted flex flex-col sm:flex-row items-center justify-between gap-3">
